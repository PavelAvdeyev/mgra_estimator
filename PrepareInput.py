...
from parsers import Handler, Anges_handler, PMAG_PLUS_handler, GapAdj_handler, MGRA_handler, Procars_handler, infercarspro_handler, Rococo_handler
        ...
        for path, name in utils.get_immediate_subdirectories(name_directory):
            for subpath, subname in utils.get_immediate_subdirectories(path):
                if tool == 'GASTS':
                    ...
                    Rococo_handler.Rococo_handler().save(subpath)
